...
const About = () => {
  return (
    <>
      <Navbar />
      <div className="pt-28 max-w-7xl mx-auto px-3">
        <Info />
        ...
        <div className="grid gap-10 lg:grid-cols-2 my-20">
          ...
          <p className="grid gap-3 text-sm">
            <span>
              ...
              animals, and the environment, reflected in our innovative programs
              for the underprivileged, animal welfare, and environmental
              conservation.
            </span>
            <span>
